...
public class BackgroundAdapter extends RecyclerView.Adapter<SomeViewHolder> {
    @Override
    public SomeViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        frameLayout.setBackgroundColor(ContextCompat.getColor(parent.getContext(), R.color.colorPrimary));
